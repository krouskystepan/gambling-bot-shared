import { readableGameNames } from '../casino/constants/defaultConfig'
import type { GlobalSettings } from '../guild/constants/defaultGlobalSettings'
import {
  getCurrencyPlacement,
  getCurrencySymbol
} from '../guild/utils/globalSettings'
